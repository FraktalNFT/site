  ...
  return (
    <section className='benefits-section'>
      <div className='heading-div'>
        ...
        <p>Collect, manage and grow together as a community of top collectors working towards disrupting the creative industry to put power back in the hands of artists and individuals.</p>
      </div>
