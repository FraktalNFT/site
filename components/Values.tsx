  ...
  return (
    <section className='values-section'>
      <div className='eth-div'>
        ...
        <p>Fractional NFTs are required to unlock the full potential of digital assets and enable NFTs to operate (integrate) efficiently within (with) DAOs.</p>
      </div>
      <div className='join'>
        <h3><Link href='https://fraktal-front-git-web3-integration-sunguru98.vercel.app/'><a><b>JOIN FRAKTAL</b></a></Link>AND SHAPE THE FUTURE OF NFT DAOs</h3>
        <div>
