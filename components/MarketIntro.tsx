  ...
  return (
    <section className="benefits-section">
      ...
      <div className="benefits-icon">
        ...
        <p>
          Retain Ownership when liquidity is needed by selling only a percentage
          of your NFT.{" "}
        </p>
      </div>
      <div className="benefits-icon">
        ...
        <p>
          Use DAOs to conduct transactions directly on the marketplace as a
          community.
        </p>
      </div>
    </section>
